...
export class PhotoService {
    getData() {
        return [
            {
                itemImageSrc: '/assets/images/Neeraj-Profile.png',
                thumbnailImageSrc: '/assets/images/Neeraj-Profile.png',
                alt: 'Description for Image 1',
                title: 'Title 1'
            },
            {
                itemImageSrc: '/assets/images/Neeraj-Profile2.jpg',
                thumbnailImageSrc: '/assets/images/Neeraj-Profile2.jpg',
